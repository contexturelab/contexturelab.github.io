...
**Constructionism and Context.** Everything we study is grounded in the recognition that we are all embedded in contexts—where we live, what we do, what we have, who we interact with—and that these contexts fundamentally construct our social categories and experiences. Categories like "success," "genius," or "community" are not natural kinds but emerge from the continuous processes shaped by our embeddedness. There is always a middle point, nuances, and spectra between apparent opposites. The lab treats social categories as constructed rather than given, using structuralist principles to identify binary oppositions while recognizing that phenomena cannot be reduced to these oppositions. Understanding how individuals and collectives are situated within larger structures, and how these structures direct human behavior and construct meaning, is central to everything we do.

**Representation Learning and Continuity.** The lab develops representation learning methods to recover the continuity that exists before we impose discrete categories. When we break continuous phenomena into bounded categories, we lose subtle yet critical nuances. Representation learning brings this continuity back into our analysis, capturing the continuous spectra that better characterize social phenomena than discrete partitions. This approach allows us to reverse-engineer how societies construct categories, revealing the underlying continuous processes that categorization obscures. The lab develops computational tools that preserve complexity and respect embeddedness rather than erasing nuance through classification.
